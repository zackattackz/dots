...
PKG_TO_INSTALL="$PKG_TO_INSTALL dbus acpid turnstile seatd pipewire feh netcat void-repo-multilib void-repo-multilib-nonfree void-repo-nonfree bluez libspa-bluetooth pkg-config"
...
SV_TO_ENABLE="$SV_TO_ENABLE dbus acpid turnstiled seatd bluetoothd wpa_supplicant"
